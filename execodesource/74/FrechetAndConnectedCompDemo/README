This archive contains code of IPOL source demonstrations inside the DGTal Libraries (version 0.6)
See the two README files:

- README_IPOL_DEMO_FrechetSimplification.txt
- README_IPOL_DEMO_ExtractionConnectedRegions.txt
...
For more details, have a look to the project homepage http://libdgtal.org
